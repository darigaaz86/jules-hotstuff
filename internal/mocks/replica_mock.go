...
//
//	mockgen -destination=../internal/mocks/replica_mock.go -package=mocks . Replica
//
...
func (mr *MockReplicaMockRecorder) NewView(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockReplica) Vote(cert hotstuff.PartialCert) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Vote", cert)
}

// Vote indicates an expected call of Vote.
func (mr *MockReplicaMockRecorder) Vote(cert any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Vote", reflect.TypeOf((*MockReplica)(nil).Vote), cert)
}
