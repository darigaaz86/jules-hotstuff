...
type ReplicaOpts struct {
	...
	Locations []string `protobuf:"bytes,22,rep,name=Locations,proto3" json:"Locations,omitempty"`
	// Tree positions of the replica.
	TreePositions []uint32 `protobuf:"varint,23,rep,packed,name=TreePositions,proto3" json:"TreePositions,omitempty"`
	// Branch Factor in tree communication
	BranchFactor uint32 `protobuf:"varint,24,opt,name=BranchFactor,proto3" json:"BranchFactor,omitempty"`
	// Tree Duration in tree communication
	TreeDelta *durationpb.Duration `protobuf:"bytes,25,opt,name=TreeDelta,proto3" json:"TreeDelta,omitempty"`
	...
	// The path to the database file for the mdbx backend.
	DbPath        string `protobuf:"bytes,28,opt,name=db_path,json=dbPath,proto3" json:"db_path,omitempty"`
...
func (x *ReplicaOpts) GetDbPath() string {
	if x != nil {
		return x.DbPath
	}
	return ""
...
type ReplicaOpts_AggregationTime struct {
	...
	AggregationTime bool `protobuf:"varint,26,opt,name=AggregationTime,proto3,oneof"`
}

type ReplicaOpts_TreeHeightTime struct {
	// TreeHeightTime computes the wait time only based on the height of the tree.
	TreeHeightTime bool `protobuf:"varint,27,opt,name=TreeHeightTime,proto3,oneof"`
}
...
var file_internal_proto_orchestrationpb_orchestration_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x89, 0x08, 0x0a, 0x0b, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63,
	...
	,
...
var file_internal_proto_orchestrationpb_orchestration_proto_depIdxs = []int32{
	23, // 0: orchestrationpb.ReplicaOpts.ConnectTimeout:type_name -> google.protobuf.Duration
	23, // 1: orchestrationpb.ReplicaOpts.InitialTimeout:type_name -> google.protobuf.Duration
	...
	23, // 4: orchestrationpb.ClientOpts.ConnectTimeout:type_name -> google.protobuf.Duration
	23, // 5: orchestrationpb.ClientOpts.RateStepInterval:type_name -> google.protobuf.Duration
	23, // 6: orchestrationpb.ClientOpts.Timeout:type_name -> google.protobuf.Duration
	15, // 7: orchestrationpb.ReplicaConfiguration.Replicas:type_name -> orchestrationpb.ReplicaConfiguration.ReplicasEntry
	16, // 8: orchestrationpb.CreateReplicaRequest.Replicas:type_name -> orchestrationpb.CreateReplicaRequest.ReplicasEntry
	17, // 9: orchestrationpb.CreateReplicaResponse.Replicas:type_name -> orchestrationpb.CreateReplicaResponse.ReplicasEntry
	18, // 10: orchestrationpb.StartReplicaRequest.Configuration:type_name -> orchestrationpb.StartReplicaRequest.ConfigurationEntry
	19, // 11: orchestrationpb.StopReplicaResponse.Hashes:type_name -> orchestrationpb.StopReplicaResponse.HashesEntry
	20, // 12: orchestrationpb.StopReplicaResponse.Counts:type_name -> orchestrationpb.StopReplicaResponse.CountsEntry
	21, // 13: orchestrationpb.StartClientRequest.Clients:type_name -> orchestrationpb.StartClientRequest.ClientsEntry
	22, // 14: orchestrationpb.StartClientRequest.Configuration:type_name -> orchestrationpb.StartClientRequest.ConfigurationEntry
