...
type ReplicaOpts struct {
	...
	// The name of the blockchain implementation to use.
	Blockchain    string `protobuf:"bytes,28,opt,name=Blockchain,proto3" json:"Blockchain,omitempty"`
...
func (x *ReplicaOpts) GetBlockchain() string {
	if x != nil {
		return x.Blockchain
	}
	return ""
...
const file_internal_proto_orchestrationpb_orchestration_proto_rawDesc = "" +
	"\n" +
	"2internal/proto/orchestrationpb/orchestration.proto\x12\x0forchestrationpb\x1a\x1egoogle/protobuf/duration.proto\"\x90\b\n" +
	"\vReplicaOpts\x12\x0e\n" +
	"\x02ID\x18\x01 \x01(\rR\x02ID\x12\x1e\n" +
	"\n" +
	"PrivateKey\x18\x03 \x01(\fR\n" +
	"PrivateKey\x12\x1c\n" +
	"\tPublicKey\x18\x10 \x01(\fR\tPublicKey\x12\x16\n" +
	...
	"\tBatchSize\x18\v \x01(\rR\tBatchSize\x12A\n" +
	"\x0eConnectTimeout\x18\x11 \x01(\v2\x19.google.protobuf.DurationR\x0eConnectTimeout\x12A\n" +
	"\x0eInitialTimeout\x18\f \x01(\v2\x19.google.protobuf.DurationR\x0eInitialTimeout\x129\n" +
	"\n" +
	"MaxTimeout\x18\x13 \x01(\v2\x19.google.protobuf.DurationR\n" +
	"MaxTimeout\x12&\n" +
	"\x0eTimeoutSamples\x18\r \x01(\rR\x0eTimeoutSamples\x12,\n" +
	"\x11TimeoutMultiplier\x18\x0e \x01(\x02R\x11TimeoutMultiplier\x12,\n" +
	"\x11ByzantineStrategy\x18\x12 \x01(\tR\x11ByzantineStrategy\x12\x1e\n" +
	"\n" +
	"SharedSeed\x18\x14 \x01(\x03R\n" +
	"SharedSeed\x12\x18\n" +
	"\aModules\x18\x15 \x03(\tR\aModules\x12\x1c\n" +
	"\tLocations\x18\x16 \x03(\tR\tLocations\x12$\n" +
	"\rTreePositions\x18\x17 \x03(\rR\rTreePositions\x12\"\n" +
	"\fBranchFactor\x18\x18 \x01(\rR\fBranchFactor\x127\n" +
	"\tTreeDelta\x18\x19 \x01(\v2\x19.google.protobuf.DurationR\tTreeDelta\x12*\n" +
	"\x0fAggregationTime\x18\x1a \x01(\bH\x00R\x0fAggregationTime\x12(\n" +
	"\x0eTreeHeightTime\x18\x1b \x01(\bH\x00R\x0eTreeHeightTime\x12\x1e\n" +
	"\n" +
	"Blockchain\x18\x1c \x01(\tR\n" +
	"BlockchainB\v\n" +
	"\tDelayType\"\x97\x01\n" +
